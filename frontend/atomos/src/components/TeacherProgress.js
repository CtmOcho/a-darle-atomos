...
import TeacherProgressCourse from './TeacherProgressCourse';
import config from '../config/config';
import './TeacherProgressPage.css';

const TeacherProgress = ({ onNavigateBack }) => {
  ...
  return (
    <div className="page-container container-fluid col-12">
      ...
      {currentView === 'course' && (
        <TeacherProgressCourse courseName={selectedCourse} onNavigateBack={handleBack} />
      )}
    </div>
  );
};
