...
const DashboardPage = () => {
  ...
  const carouselItems = [
    ...
    'Sodio Metálico y Agua', 'Camaleón Químico', 'Experimento de Rutherford', 'Lluvia Dorada', 'Identificación Ácido-base', 'Pasta de Dientes para Elefantes'
  ];
    ...
    <div className="dashboard-container">
      ...
      <div className="carousel-container">
        ...
        <div className="carousel">
          <button className="carousel-item">{carouselItems[currentIndex]}</button>
        </div>
